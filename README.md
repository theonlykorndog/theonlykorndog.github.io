# theonlykorndog Repsository: v1.0.8
## Tweaks Wizard:             v1.0.5
...
<p align="left">
  <ul>
    ...
    <li>Note the HTTPS, check for errors then select <strong>OK</strong>.</li>
    ...
    <li>Wait for the <strong>Add-on installed</strong> notification, go to and select <strong>Open</strong> to open the <strong>Tweaks Wizard</strong> add-on.</li>
  </ul>
</p>
