...
*Alternatively, select <strong><a href="repository.theonlykorndog-1.0.8.zip"><code>repository.theonlykorndog-1.0.8.zip</code></a></strong> then install the <strong>Tweaks Wizard</strong> from the <strong>theonlykorndog Repository</strong>.
